    ...
    public <T> T executeApiRequest(HttpUriRequest request, final Type typeOfT)
            ...
            if (server.useApiAccess()) {
                ...
                if (locationHeader != null) {
                    ...
                    if (redirectUrl.getPath().contains("error.jsp")) {
                        String message = URLDecoder.decode(redirectUrl.getQuery(), "UTF-8");
        ...
        if (contentType == null) {
            ...
            if (!contentType.getValue().equals("application/json")) {
                ...
                throw new NamiApiException("Content-Type of response is not application/json.");
            }
        }
        ...
        if (server.useApiAccess()) {
            ...
            NamiApiResponse<T> resp = gson.fromJson(new InputStreamReader(responseEntity.getContent()), type);
            ...
            T resp = gson.fromJson(new InputStreamReader(responseEntity.getContent()), typeOfT);
            return resp;
        }
    }

    /**
     * Liefert einen URIBuilder f�r den NaMi-Server dieser Connection.
     * 
     * @param path
